            ...
            <div class="card">
                ...
                <div style="overflow-x:auto;">
                    <table class="ppmis-table">
                        ...
                        <tbody>
                        <?php if (empty($firms)): ?>
                            <tr><td colspan="5" style="text-align:center;padding:32px;color:#aaa;">No firms yet.</td></tr>
                        <?php else: ?>
                            ...
                            <tr style="<?= !$f['is_active'] ? 'opacity:0.5;' : '' ?>">
                                ...
                                <td style="font-size:13px;"><?= h($f['contact_person'] ?? '—') ?></td>
                                <td>
                                ...
                                <td>
                                    <form method="POST" style="display:inline;">
                                        ...
                                        <button type="submit" class="btn-preview" style="font-size:11px;padding:4px 10px;">
